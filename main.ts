...
basic.forever(function () {
    ...
    lpredkosc = Math.floor(kalib / (mbieg + 1 - lbieg)) // tutaj trzebya wymyśleć jak zrobić dobrze biegi
    ...
    ppredkosc = Math.floor(kalib / (mbieg + 1 - pbieg))
